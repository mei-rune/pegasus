...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(PEGASUS)\src" /I "$(PEGASUS)\src\Pegasus\compiler\nt_includes" /D "_DEBUG" /D "PEGASUS_INTERNALONLY" /D "PEGASUS_PLATFORM_WIN32_IX86_MSVC" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "PEGCOMPILER_EXPORTS" /D "PEGASUS_COMPILER_INTERNAL" /D "PEGASUS_MEMORY_DEBUG" /D "PEGASUS_USE_EXPERIMENTAL_INTERFACES" /FR /FD /GZ /c
# SUBTRACT CPP /YX
